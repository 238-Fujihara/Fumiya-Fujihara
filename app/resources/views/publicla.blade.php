...
<h1>Los Angeles</h1>
        ...
        <div class="seattlepost">
            ...
            <div class="searching">
                ...
                <form action="{{ route('public.la') }}" method="GET">
                    @csrf
        ...
        <div class="edmondsdetail">
            ...
            <div class="date">
                <h3>"{{ $lapost['title'] }}"</h3>
                <h4>{{ $lapost['date'] }}</h4>
                <a href="{{ asset($lapost->image) }}" data-lightbox="group"><img src="{{ asset($lapost->image) }}" width="100"></a>
                <a href="{{ route('laviolation', $lapost->id) }}">
